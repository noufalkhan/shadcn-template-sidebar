...
See `docs/ROUTING_GUIDE.md` for layout selection rules, naming conventions, and the recommended minimal -> with-header app flow.

## Typography Consistency

Use `docs/TYPOGRAPHY_GUIDE.md` as the source of truth for text size choices (sidebar, header, titles, descriptions, and body text).

## Table Behavior

Use `docs/TABLE_BEHAVIOR_GUIDE.md` to understand when to use base table primitives vs feature-specific request table UI.
